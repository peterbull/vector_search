...
SERVER_EMAIL = config("DEFAULT_FROM_EMAIL", default="vector-search <noreply@vector_search.com>")
...
#
HEROKU_APP_NAME = config("HEROKU_APP_NAME", default="vector_search-staging")
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            os.path.join(BASE_DIR, "vector_search", "client", "templates"),  # Swagger template override
        ],
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "vector_search.core.pagination.PageNumberPagination",
...
if config("USE_AWS_STORAGE", cast=bool, default=False) and not IS_REVIEW_APP:
    ...
    DEFAULT_FILE_STORAGE = "vector_search.utils.storages.PrivateMediaStorage"
    # STATICFILES_STORAGE = "vector_search.utils.storages.StaticRootS3Boto3Storage"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "vector_search.request": {"handlers": [], "level": "INFO", "propagate": True},
        "vector_search.tasks": {"handlers": [], "level": "INFO", "propagate": True},
    },
}
...
if IN_PROD or ROLLBAR_ACCESS_TOKEN:
    ...
    LOGGING["loggers"]["vector_search"]["handlers"].append("rollbar")

# Popular testing framework that allows logging to stdout while running unit tests
TEST_RUNNER = "django_nose.NoseTestSuiteRunner"

CORS_ALLOWED_ORIGINS = ["https://vector-search-staging.herokuapp.com", "https://vector-search.herokuapp.com"]
